...
const ProductItem = ({ product }) => {
  return (
    <div className="custom-shadow cursor-pointer rounded-xl overflow-hidden group">
      <article>
        ...
        <div className="px-3 pt-6 pb-4 flex flex-col gap-y-1">
          <h2 className="font-medium text-[#09c] hover:text-[#f97316] duration-200">
